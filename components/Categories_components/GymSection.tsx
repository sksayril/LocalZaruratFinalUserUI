    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 -mt-20 relative z-10">
          <Link href="/gym/membership" className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12">
                <img src="https://img.icons8.com/color/96/membership-card.png" alt="Get Membership" className="w-full h-full" />
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-1">Get Membership</h3>
                <p className="text-gray-600">Join Today →</p>
              </div>
            </div>
          </Link>

          <Link href="/gym/trending" className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12">
          ...
          <Link href="/gym/find" className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12">
                <img src="https://img.icons8.com/color/96/gym.png" alt="Find Gyms" className="w-full h-full" />
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <Link href="/gym/strength" className="relative h-[300px] rounded-lg overflow-hidden group">
            <img 
            ...
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
              <h2 className="text-3xl font-bold text-white">Strength Training</h2>
            </div>
          </Link>

          <Link href="/gym/cardio" className="relative h-[300px] rounded-lg overflow-hidden group">
            <img 
          ...
          <Link href="/gym/yoga" className="relative h-[300px] rounded-lg overflow-hidden group">
            <img 
