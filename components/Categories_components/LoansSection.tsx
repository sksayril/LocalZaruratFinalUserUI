    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 -mt-20 relative z-10">
          <Link href="/loans/apply" className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12">
                <img src="https://img.icons8.com/color/96/loan.png" alt="Apply Loan" className="w-full h-full" />
              </div>
              <div>
          ...
          <Link href="/loans/trending" className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12">
          ...
          <Link href="/loans/compare" className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12">
                <img src="https://img.icons8.com/color/96/calculator.png" alt="Compare Loans" className="w-full h-full" />
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <Link href="/loans/personal" className="relative h-[300px] rounded-lg overflow-hidden group">
            <img 
          ...
          <Link href="/loans/home" className="relative h-[300px] rounded-lg overflow-hidden group">
            <img 
          ...
          <Link href="/loans/business" className="relative h-[300px] rounded-lg overflow-hidden group">
            <img 
