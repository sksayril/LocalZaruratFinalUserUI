      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <a href="/" className="flex items-center select-none">
            ...
            <span className="text-2xl font-bold text-orange-500 ml-1">Zarurat</span>
          </a>
          ...
          <nav className="flex items-center space-x-6">
            ...
            <a href="#" className="text-sm font-semibold hover:text-blue-600">We are Hiring</a>
            <a href="#" className="text-sm font-semibold hover:text-blue-600">Investor Relations</a>
            {/* Leads with red dot */}
            ...
            <button className="bg-blue-600 text-white px-5 py-2 rounded-lg text-sm font-bold hover:bg-blue-700 ml-2">
              Login / Sign Up
            </button>
          </nav>
        </div>
